...
const DashboardHeader = () => {
	...
	const { user, establishmentt, logOut } = useContext(DefaultContext)
	const styledBtn = {
	...
	return (
		<Header>
			<HeaderLeft>
				...
				<span className='h4 mb-0 fw-bold'>Bem vindo {user?.name}!</span>
				<h5>  Resumo do  Estabelecimento  {establishmentt?.social_name}</h5>
			</HeaderLeft>
