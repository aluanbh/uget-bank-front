...
const TableCustomAdicionar = ({ columns, rows, keyExtractor, onClick }) => {
	...
	return (
		<>
			<div style={{ marginBottom: 20 }} className='d-flex flex-row-reverse'>
				<Button
...
export default memo(TableCustomAdicionar);
